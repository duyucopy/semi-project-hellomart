...
ALTER TABLE product ADD CONSTRAINT IDX_product_FK0 FOREIGN KEY (ct_no) REFERENCES categories (ct_no) on delete cascade;
...
ALTER TABLE address ADD CONSTRAINT IDX_address_FK0 FOREIGN KEY (userId) REFERENCES userinfo (userId) on delete cascade;

ALTER TABLE board ADD CONSTRAINT IDX_board_PK PRIMARY KEY (boardno);
ALTER TABLE board ADD CONSTRAINT IDX_board_FK0 FOREIGN KEY (p_no) REFERENCES product (p_no) on delete cascade;
