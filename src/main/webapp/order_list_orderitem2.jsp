...
<%@page import="com.itwill.hellomart.order.OrderItem"%>
<%@page import="com.itwill.hellomart.order.Order"%>
...
List<Order> orderList = orderService.findOrderWithOrderItemByUserId(sUserId);
%>
